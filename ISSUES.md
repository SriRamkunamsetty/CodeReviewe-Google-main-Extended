# CodeReviewer-Google — Issue Tracker
...
|---|-------|----------|--------|------------|----------------|
| 1 | CORS misconfiguration blocks Hugging Face deployments | P0 | `[o]` | [#2](https://github.com/archittmittal/CodeReviewer-Google/issues/2) | [#51](https://github.com/SriRamkunamsetty/CodeReviewer-Google/issues/51) |
| 2 | Implementer commits dummy code instead of real file changes | P0 | `[o]` | [#3](https://github.com/archittmittal/CodeReviewer-Google/issues/3) | [#52](https://github.com/SriRamkunamsetty/CodeReviewer-Google/issues/52) |
...
|------|---------------|-----------------|
| 2026-06-12 | Fork [#2](https://github.com/archittmittal/CodeReviewer-Google/issues/2), [#3](https://github.com/archittmittal/CodeReviewer-Google/issues/3) · Upstream [#51](https://github.com/SriRamkunamsetty/CodeReviewer-Google/issues/51), [#52](https://github.com/SriRamkunamsetty/CodeReviewer-Google/issues/52) | — |
